...
{
	// Keep calling until cursor reaches 0
	while (::ShowCursor(FALSE) >= 0);
}

void Window::ShowCursor()
{
	// Keep calling until cursor reaches below 0
